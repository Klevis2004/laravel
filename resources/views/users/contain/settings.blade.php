                            ...
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-12">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <div
                                                            style="width: 100px; height: 100px; overflow: hidden; border-radius: 50%; margin-right: 10px;">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="inputPasswordConfirm"
                                                            ...
                                                            name="re-password" value="{{ Auth::user()->password }}" />
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="{{ route('welcome') }}">Back to home page</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
