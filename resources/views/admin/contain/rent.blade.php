        ...
        <div class="container-fluid pt-4 px-4">
            <div class="bg-light text-center rounded p-4">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <h6 class="mb-0">Librat për tu marrë: {{ $count }}</h6>
                    <a href="#">Show All</a>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($sale->status == 0)
                                            <div class="status-container"><span
                                                    class="status-point pending"></span>Pending</div>
                                    ...
                                    <td>
                                        ...
                                        @elseif ($sale->payment_status == 1)
                                            <div class="status-container"><span
                                                    class="status-point completed"></span>Completed
                                            </div>
                                        @endif
                                    </td>

                                    <td>{{ $sale->bill }}</td>
                                    <td>{{ $sale->data_marrjes }}</td>
                                    <td>{{ $sale->data_dorezimit }}</td>
                                    <td>
                                        <form action="{{ route('dorezimi', ['id' => $sale->id]) }}" method="POST">
                                            @csrf
                                            @method('put')
                                    ...
                                    <td>
                                        <a href="{{ route('sale.delete', ['id' => $sale->id]) }}"
